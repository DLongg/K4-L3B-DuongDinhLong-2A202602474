...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Tách câu dựa trên ranh giới . ! ? mà không làm mất dấu câu
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        if not remaining_separators:
            # Base case: fallback to hard character slicing when no separators are provided
            ...
            if len(piece) > self.chunk_size:
                ...
                for sub in sub_chunks:
                    ...
                    if len(sub) > self.chunk_size:
                        ...
                        current_chunk = sub
                    elif len(current_chunk) + len(sep) + len(sub) <= self.chunk_size:
                        current_chunk = current_chunk + sep + sub
                    else:
                        chunks.append(current_chunk)
                        current_chunk = sub
            else:
